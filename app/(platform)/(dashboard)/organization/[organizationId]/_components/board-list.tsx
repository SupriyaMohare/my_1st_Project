...
export const BoardList =  async() => {
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3  lg:grid-cols-4 gap-4">
               {boards.map((board)=>(
                ...
                className="group relative aspect-video bg-no-repeat
                 bg-center bg-cover bg-sky-700 rounded-sm h-full w-full 
                 p-2 overflow-hidden"
                ...
                <FormPopover sideOfSet={10} side="right">
    ...
    justify-center  hover:opacity-75 transition">
                    ...
                    <span className="text-x5">
                        {isPro? "Unlimted":`${MAX_FREE_BOARDS-availableCount} remaining`}
                    </span>

                    <Hint
                    
                    sideOffset={40}
                    description={`Free Workspacees can have up to 5 open boards.
